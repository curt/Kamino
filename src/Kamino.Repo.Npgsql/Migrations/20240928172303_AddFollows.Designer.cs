...
namespace Kamino.Repo.Npgsql.Migrations
{
    ...
    [Migration("20240928172303_AddFollows")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kamino.Entities.Follow", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AcceptUri")
                        .HasColumnType("text")
                        .HasColumnName("accept_uri");

                    b.Property<string>("ActivityUri")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("activity_uri");
                    ...
                    b.HasAlternateKey("ActivityUri")
                        .HasName("ak_follows_activity_uri");

                    b.HasAlternateKey("ActorUri", "ObjectUri")
                        .HasName("ak_follows_actor_uri_object_uri");

                    b.ToTable("follows", (string)null);
                });

            modelBuilder.Entity("Kamino.Entities.Like", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasAlternateKey("ActivityUri")
                        .HasName("ak_likes_activity_uri");

                    b.HasAlternateKey("ActorUri", "ObjectUri")
                        .HasName("ak_likes_actor_uri_object_uri");

                    b.ToTable("likes", (string)null);
                });

            modelBuilder.Entity("Kamino.Entities.Ping", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ToUri")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("to_uri");

                    b.HasKey("Id")
                        .HasName("pk_pings");

                    b.HasAlternateKey("ActivityUri")
                        .HasName("ak_pings_activity_uri");
            ...
            modelBuilder.Entity("Kamino.Entities.Pong", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasAlternateKey("ActivityUri")
                        .HasName("ak_pongs_activity_uri");

                    b.HasIndex("PingId")
                        .HasDatabaseName("ix_pongs_ping_id");
            ...
            modelBuilder.Entity("PostsPlaces", b =>
                {
                    ...
                    b.HasIndex("PostsId")
                        .HasDatabaseName("ix_posts_places_posts_id");
            ...
            modelBuilder.Entity("Kamino.Entities.Pong", b =>
                {
                    b.HasOne("Kamino.Entities.Ping", "Ping")
                        .WithMany("Pongs")
                        .HasForeignKey("PingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pongs_pings_ping_id");
            ...
            modelBuilder.Entity("PlacesTags", b =>
                {
                    ...
                    b.HasOne("Kamino.Entities.Tag", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_places_tags_tags_tags_id");
                });
            ...
            modelBuilder.Entity("PostsPlaces", b =>
                {
                    ...
                    b.HasOne("Kamino.Entities.Post", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_posts_places_posts_posts_id");
                });
